...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/userServiceView': 'build/karma/src',
      'nmodule/userServiceViewTest': 'build/karma/srcTest',
  ...
  define('nmodule/userServiceView/rc/userServiceView.built.min');
  ...
  require([ 'niagara-test-server/karmaUtils',
     ...
     */
    //testOnly('rc/userServiceView');
    testOnly('');

    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: [ 'nmodule/userServiceViewTest/rc/spec/allSpecs' ]
    }, function (err) {
